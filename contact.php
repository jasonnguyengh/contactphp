...
<html lang="en">
 <head>
     <title>Jason Nguyen: Responsive Website</title>
  <meta charset="utf-8" />
 ...
 <body>
     ...
     <h1>Jason Nguyen</h1>
        <nav class="topnav" id="myTopnav">
            ...
            <a href="http://web-students.net/site63/web150/timeofday/" target="_blank">Time Of Day</a>
            <a href="http://web-students.net/site63/web150/daily/" target="_blank">Daily Grind</a>
            <a href="http://web-students.net/site63/web150/domplay/" target="_blank">DOM Play</a>
            <a href="https://github.com/jasonnguyengh" target="_blank">GitHub</a>
            <a href="https://www.linkedin.com/in/jasonnguyen0109" target="_blank">LinkedIn</a>
   ...
   <main class="wrapper">
     ...
     -->  
       ...
       if(isset($_POST['Name'])){//show data
        ...
        $to  = 'jason.h.nguyen@seattlecolleges.edu';//put your email here
     ...
     <footer>
      <p><small>&copy; 2019 by <a href="contact.php">Contact Jason Nguyen </a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
    </footer>
  </main>
